...
Coffee.prototype.toString =function() {
    console.log("make order for cofee: " + this.flavor + " total to pay : " + this.price);
}
...
var Cappuccino = function(drink, flavor) {
    this.drink = drink;
    this.coffee = coffee;
    this.flavor = "Cocoa";
...
Cappuccino.prototype.toString =function() {
    console.log("make order for cappuccino: " + this.flavor + " total to pay : " + this.price);
}
